        ...
        if (isset($_POST['action']) && $_POST['action'] === 'add') {
            $stmt = $db->prepare("
                INSERT INTO plans (
                    ...
                    display_order, status, hidden, features
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label class="checkbox-label">
                            ...
                            <span>Hidden Product (Not shown to clients)</span>
                        </label>
                        <small style="color:var(--text-secondary);">Use for custom packages, grandfathered plans, or special deals</small>
                    </div>
                    <div class="form-group">
